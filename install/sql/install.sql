...
--
-- Host: localhost:3306
-- Generation Time: Feb 27, 2017 at 05:51 AM
...
CREATE TABLE IF NOT EXISTS `client_user_login` (
...
CREATE TABLE IF NOT EXISTS `course_add` (
...
CREATE TABLE IF NOT EXISTS `course_chapter_add` (
...
CREATE TABLE IF NOT EXISTS `course_question_relation` (
  `question_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `data_entry_operator` (
...
CREATE TABLE IF NOT EXISTS `exam_backup` (
...
CREATE TABLE IF NOT EXISTS `exam_head` (
  `exam_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `find_popular_course` (
  `course_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `model_test_details` (
  `model_test_id` int(11) NOT NULL,
  `question_ids` longtext CHARACTER SET latin1 NOT NULL,
  `status` int(2) NOT NULL,
  PRIMARY KEY (`model_test_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `model_test_head` (
  `model_test_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `model_test_result` (
  `model_test_id` int(11) NOT NULL,
  `user_id` varchar(255) CHARACTER SET latin1 NOT NULL,
  `model_test_settings_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `model_test_result_details` (
  `model_test_id` int(11) NOT NULL,
  `user_id` varchar(255) CHARACTER SET latin1 NOT NULL,
  `questions_ids` text CHARACTER SET latin1 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `model_test_settings` (
  `model_test_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `question_creator_relation` (
...
CREATE TABLE IF NOT EXISTS `tutor_batch` (
...
CREATE TABLE IF NOT EXISTS `tutor_batch_details` (
...
CREATE TABLE IF NOT EXISTS `tutor_batch_exam` (
  `batch_assign_id` int(11) NOT NULL AUTO_INCREMENT,
  `batch_id` int(11) NOT NULL,
  `tutor_id` varchar(255) CHARACTER SET latin1 NOT NULL,
  `exam_id` int(11) NOT NULL,
  `status` int(2) NOT NULL,
  PRIMARY KEY (`batch_assign_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3 ;
...
CREATE TABLE IF NOT EXISTS `user_exam_result_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `exam_id` int(11) NOT NULL,
  `user_id` varchar(255) CHARACTER SET latin1 NOT NULL,
