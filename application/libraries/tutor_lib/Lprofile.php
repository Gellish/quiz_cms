...
class Lprofile {
	...
	public function get_user_all_info()
	{
		...
		$exam_view = $CI->parser->parse('tutor_view/profile/profile',$data,true);
		return $exam_view;
	}
	...
	public function get_edit_full_name_view()
	{
		...
		$info_edit_view = $CI->parser->parse('tutor_view/profile/full_name_view',$data,true);
	...
	public function get_edit_user_cellno_view()
	{
		...
		$info_edit_view = $CI->parser->parse('tutor_view/profile/cell_number_view',$data,true);
		return $info_edit_view;
	}
	...
	public function get_change_password_view()
	{
		...
		$change_pass_view = $CI->parser->parse('tutor_view/profile/change_password',$data,true);
