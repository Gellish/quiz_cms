...
<div id="myProfile">
	<div class="well" style="margin-top: 10px;">
		<div style="font-size:25px;font-weight:bold;"><?php echo display('general_account_setting')?>
		</div>
	</div>
	<table class="table table-striped table-bordered">
		...
		<tr class="specTRcolor">
			...
			<td>
				<?php echo form_open('tutor/User_profile/do_user_cellno_edit',array('class' => 'form-horizontal','id' => 'user_cellno_edit' ))?>
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group row">
								<label for="example-text-input" class="col-sm-4 col-form-label"><?php echo display('mobile_no')?></label>
								<div class="col-sm-7">
									<input type="text" id="mobile_no" name="mobile_no" value="{mobile_no}" class="OnePxBorder required form-control" >
								</div>
							</div>
