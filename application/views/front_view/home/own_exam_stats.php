                        ...
                        ?>
                            ...
                            <tbody>
								...
								<tr>
									...
									<td>{course_name}</td>
									<td>
										<a href="<?php echo base_url('front/user_exam_info/view_personal_exam_result')?>/{exam_id}" style="color:white"><button type="submit" class="btn theme-btn"><?php echo display('details')?></button></a>
									</td>
								</tr>
								{/exam_statistics}
                            </tbody>
