                        ...
                        ?>
                            ...
                            <tbody>
								...
								<tr>
									...
									<td>{assign_date}</td>
									<td>
										<a href="<?php echo base_url('front/user_exam_info/view_schedule_exam_result')?>/{exam_id}" style="color:white"><button type="submit" class="btn theme-btn"><?php echo display('details')?></button></a>
									</td>
								</tr>
								{/exam_statistics}
                            </tbody>
