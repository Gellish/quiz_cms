...
<div class="well" style="margin-top: 10px;">
	<div style="font-size:25px;font-weight:bold;"><?php echo display('add_advertisement') ?></div>
</div>
<div class="row-fluid">
	<?php echo form_open('admin/Cadvertisement/submit_advertisement',array('class' => 'well form-horizontal','id' => 'course_add','enctype' => 'multipart/form-data' ))?>
    	<div class="row">
			<div class="col-md-4">
	        	...
	        	<div class="embed_code_ad" style="display: block;">
	                <div class="control-group">
	                    ...
	                    <textarea id="mytextarea" name="add_code" class="form-control"></textarea>
	                </div> 
	            </div>
	            <br>
				...
				<div class="control-group">
					<div class="controls">
						...
						<input type="submit" class="btn btn-info" value="<?php echo display('save_another') ?>" name="add-chapter-another">
					</div>
				</div>
			</div>
		</div>
