...
<div class="well" style="margin-top: 10px;">
	<div style="font-size:25px;font-weight:bold;"><?php echo display('add_question_option')?></div>
</div>
<div class="row-fluid">
	<?php echo form_open('admin/Cquestion/insert_question_single_option',array('class' =>'well form-horizontal','id' => 'course_add' ))?>

	    <div class="row">
		    <div class="col-md-6">
		    	<div class="form-group row">
					<label for="example-text-input" class="col-sm-3 col-form-label"><?php echo display('option_details')?></label>
					<div class="col-sm-7">
				...
				<div class="form-group row">
					<label for="example-text-input" class="col-sm-3 col-form-label"><?php echo display('option_image')?></label>
				  	<div class="col-sm-7">
				   		<input type="file" name="optionImage" class="form-control">
				  	</div>
				</div>
				<div class="form-group row">
