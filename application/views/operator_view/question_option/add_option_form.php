...
<div class="row-fluid">
	<?php echo form_open('operator/Oquestion/insert_question_single_option',array('class' => 'well form-horizontal', 'id' => 'course_add'))?>
   		<div class="row">
		    <div class="col-md-6">
			      	...
			      	<div class="col-sm-7">
				        <div class="form-check">
				          <label class="form-check-label">
				            <input type="checkbox" class="form-check-input" name="is_answer">
				          </label>
